...
<head>
<meta charset="UTF-8">
<title>이미지 첨부 파일 페이지</title>
<script src="https://code.jquery.com/jquery-3.7.1.js">
</script>
</head>
<body>
	<h1>파일 업로드</h1>
	<form id="ReviewImageForm" action="attach" method="post"
	...
	$(document).ready(function() {
		...
		var blockedExtensions = /\.(exe|sh|php|jsp|aspx|zip|alz|txt)$/i; 
			
		// 파일 전송 form validation
		$("#ReviewImageForm").submit(function(event) {
